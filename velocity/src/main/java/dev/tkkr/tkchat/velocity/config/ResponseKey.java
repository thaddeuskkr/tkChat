...
public enum ResponseKey {
    ...
    GROUP_STATUS_OWNER("group.status-owner"),
    GROUP_STATUS_MEMBERS("group.status-members"),
    GROUP_STATUS_INVITED_TAG("group.status-invited-tag"),
    GROUP_STATUS_OFFLINE_TAG("group.status-offline-tag"),
    ...
    GROUP_LIST_PUBLIC_ENTRY("group.list-public-entry"),
    GROUP_LIST_OWNER("group.list-owner"),
    ...
    GROUP_INVITE_MEMBERS("group.invite-members"),
