...
plugin-version folder, such as `build/releases/0.7.1/`, and include the plugin version in each jar
name, such as `tkChat-Velocity-0.7.1.jar`.
...
creates the matching GitHub tag and release (for example, `v0.7.1`), attaches all 7 jars, and then
